...
enum StageRenderer {
    ...
    static func build(stage: GrowthStage, repoCount: Int = 1,
        ...
        // Body color: use PushlingPalette.bone directly — guaranteed visible.
        // The warm cream always renders clearly on OLED dark backgrounds.
        let bodyColor = PushlingPalette.bone
