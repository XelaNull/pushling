...
| Golden Hour / Evening Wind-Down ritual | [environment-reactions.md §7](/SYSTEMS/environment-reactions.md#7-golden-hour-dusk-vantage), [idle-life-and-rest.md §8](/SYSTEMS/idle-life-and-rest.md#8-evening-wind-down-ritual) | Golden Hour: once per dawn, once per dusk. Wind-Down: once nightly, scheduled not rolled | Yes — Golden Hour's own spec (§7 of that doc, the origin of the number) already states a 10-minute invitation-suppression window, tighter than this floor; the floor is the fallback for the other four families it didn't already consider |
